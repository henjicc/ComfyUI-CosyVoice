...
class CosyVoiceFrontEnd:
    ...
    def _extract_speech_token(self, speech):
        ...
        # 检查音频长度（转换为秒）
        assert speech.shape[0] / 16000 <= 30, 'do not support extract speech token for audio longer than 30s'
        
        # 添加批次维度以适配whisper.log_mel_spectrogram
